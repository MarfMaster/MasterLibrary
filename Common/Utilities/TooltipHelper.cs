...
{
       /// <summary>
       /// Call this in any GlobalItem SetStaticDefaults function to use a list to register a dictionary of ItemIDs and the tooltips keys' you want to add for those items, for adding localization entries which are to be displayed by your mod.
       /// You can then use the same lists in a for loop to display those tooltips in a ModifyTooltips function, using SimpleTooltip.
       ...
       /// <summary>
       /// Call this in any GlobalItem SetStaticDefaults function to register a dictionary of item IDs and tooltip keys' you want to add for a single item, for adding localization entries which are to be displayed by your mod.
       /// You can then use the same list in a for loop to display those tooltips in a ModifyTooltips function, using SimpleTooltip.
       /// If you want to add multiple tooltips to a single item, you'll have to use multiple calls and dictionaries.
       /// </summary>
              ...
              params string[] tipsToAdd)
       {
              if (item.type == itemId)
              {
                     ...
                     if (ttindex != -1)
                     {
                            for (int i = 0; i < tipsToAdd.Length; i++)
                            {
       ...
       /// <summary>
       /// Adds a tooltip to all items. Generally, you want to restrict this by only running it if the item meets certain criteria, since you rarely, if ever, should be adding tooltips to all items in the game.
       /// </summary>
       /// <param name="mod"></param>
       /// <param name="tooltips"></param>
       /// <param name="tipsToAdd"></param>
