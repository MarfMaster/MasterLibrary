...
public abstract class ModdedBiomeFishingCrate : ModItem
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        ItemID.Sets.IsFishingCrateHardmode[Type] =
            IsHardmodeCrate; // This is a crate that mimics a pre-hardmode biome crate, so this is commented out
    ...
    public override void SetDefaults()
    {
        ...
        Item.width =
            12; // The hitbox dimensions are intentionally smaller so that it looks nicer when fished up on a bobber
        Item.height = 12;
        Item.rare = Rarity;
        Item.value = Value;
    }
    ...
    public override void ModifyItemLoot(ItemLoot itemLoot)
    {
        ...
        var minHealPotAmount = 5;
        var maxHealPotAmount = 17;
