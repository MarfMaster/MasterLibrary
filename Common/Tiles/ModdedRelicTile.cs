...
namespace MLib.Common.Tiles;
	...
	public abstract class ModdedRelicTile : ModTile
	{
		...
		public override string Texture => "MLib/Assets/Tiles/RelicPedestal";

		public override void Load() 
		{
			// Cache the extra texture displayed on the pedestal
			RelicTexture = ModContent.Request<Texture2D>(this.GetType().Namespace.Replace(".", "/") + "/" + Name);
		}
